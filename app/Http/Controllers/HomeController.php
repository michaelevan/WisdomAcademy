        ...
        if($username == null || $password == null){
            ...
            if ($idx == -1) {
                ...
                if ($listUsers[$idx]->status == 0) {
                    ...
                    return response(view("general.login", ["msg" => "anda telah lulus!"]));
                }
                    ...
                    // if (Hash::check($password, $listUsers[$idx]->password)) {
                        ...
                        if ($listUsers[$idx]->role == "admin") {
                            ...
                            $countNotif = Notifikasi::join('detail_kelas', 'notifikasi.id_anak', '=', 'detail_kelas.id_detailsiswa')->where('notifikasi.status', 0)->where('detail_kelas.id_detailsiswa', $getID)->count();
