...
<aside
    ...
    <div id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'evaluasi' ? 'active bg-gradient-warning' : '' }} "
                    href="{{url('/orangTua/evaluasi')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-receipt ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Laporan Evaluasi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'chat' ? ' active bg-gradient-warning' : '' }} "
                    href="{{url('/orangTua/chat')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
