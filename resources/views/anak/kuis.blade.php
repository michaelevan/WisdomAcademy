            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        <li class="nav-item">
                            <a class="nav-item nav-link" href="{{url('/anak/mapel/'.$id.'/materi')}}">
                        ...
                        <li class="nav-item" style="background-color: white; box-shadow: -2px -2px 3px #ffffff, 2px 2px 3px #a0a0a0; border-radius: 8px">
                            <a class="nav-item nav-link"  href="{{url('/anak/mapel/'.$id.'/kuis')}}">
                ...
                <div class="card-body p-3"><br>
                    <div class="row" style="padding: 2%">
                            ...
                            @for ($i=0; $i < count($arrNoBulan); $i++)
                                @if ($arrNoBulan[$i] == $bulan)
                                    <div class="kotakBulan">
                                        <a href="{{url('/anak/mapel/'.$id.'/kuis/bulan/'.$arrNoBulan[$i])}}">
                        ...
                        <div class="mb-3 col-md-8" style="margin-left: 10%">
                            <h4>List kuis</h4><br><br>
                            @if (count($listKuis) == null)
                                <p style="font-size: 20px">Tidak ada kuis</p>
                            @else
                                @foreach ($listKuis as $kuis)
                                    <a href="{{ url('/anak/mapel/'.$id.'/kuis/'.$kuis->id_kuis) }}">
                                        <div class="kotak">
                                            <div class="d-flex">
                                                ...
                                                <div class="mb-3 col-md-3" style="margin-top: 1%">
                                                    <p>{{ date('d F Y', strtotime($kuis->updated_at)) }}</p>
                                                </div>
                                                <div class="mb-3 col-md-1" style="margin-top: 1%">
                                                    <p>{{ date('H:i', strtotime($kuis->updated_at)) }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
