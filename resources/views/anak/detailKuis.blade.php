...
<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <a href="{{url('/anak/mapel/'.$id.'/kuis')}}" style="margin-left: 2%"> << Kembali</a>
        <!-- End Navbar -->
                    ...
                    <div class="card my-1">
                        <div class="card-body p-3">
                                        ...
                                        @if ($hasilKuis == null)
                                            <div class="mb-0 col-md-4" style="display: flex; justify-content: flex-end">
                                                ...
                                                <?php
                                                    ...
                                                    $tglExpKuis = new DateTime($kuis->batas_waktu);
                                                ?>
                                                @if ($tglSaatIni > $tglExpKuis)
                                                    <strike><p>Melebihi Batas Waktu</p></strike>
                                                @endif
                                            </div>
                                        @else
                            ...
                            <div style="display: flex; justify-content: flex-end;">
                                @if ($hasilKuis == null)
                                    <div style="display: flex; justify-content: flex-end;">
                                        <button class="btn bg-gradient-dark" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Mulai Kuis</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Siap Untuk Mengerjakan Kuis? Tekan Tombol Ya!</h5>
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn bg-gradient-primary btn-link" href="{{ url('/anak/mapel/'.$id.'/kuis/'.$kuis->id_kuis.'/isiKuis') }}">Ya</a>
                            </div>
                        </div>
                    </div>
                </div>
